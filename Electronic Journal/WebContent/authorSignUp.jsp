...
<form class="fm-form" method="post" action="http://localhost:8080/FirstWeb/SignUpServlet" name="signup" id="signup" autocomplete="on">
<fieldset>
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="email" id="email" style="width:300px;" placeholder="Primary e-mail "/></td>
	</tr>
	<tr>
		<td>Password</td>
		<td><input type="password" name="password" id="password" placeholder="Your Passord"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="fname" id="fname" style="width:300px;" placeholder="Enter Given Name"/></td>
	</tr>
	
	<tr>
		<td style="width:200px"><label>Last Name&nbsp;<em>*</em></label></td>
		<td><input type="text" name="lname" id="lname" style="width:300px;" placeholder="Enter Family Name"/></td>
	</tr>
	...
	<tr>
		<td style="width:200px"><label>Other Branch</label></td>
		<td><input type="text" name="otherbranch" id="otherbranch" style="width:300px;" placeholder=""/></td>
	</tr>
	<tr>
		<td style="width:200px"><label>Qualification&nbsp;<em>*</em></label></td>
		<td><select name="qualification" id="qualification" style="width:px;"><option value="0">...</option><option value="1">PhD</option><option value="2">Post Doctorates</option><option value="3">MSc</option><option value="4">M.Tech</option><option value="5">MCA</option><option value="6">M.E</option><option value="7">Post Graduate Diploma</option></select><input type="hidden" id="custom_list-53761c7a9c9d8-list-style" value="select"/><input type="hidden" id="customcount" value="7"/></td>
	</tr>
	<tr>
		<td style="width:200px"><label>University/Organisation&nbsp;<em>*</em></label></td>
		<td><input type="text" name="organisation" id="organisation" style="width:300px;" placeholder=""/></td>
	</tr>
	<tr>
		<td style="width:200px"><label>Title&nbsp;<em>*</em></label></td>
		<td><select name="custom_list-53761c7a9d977" id="custom_list-53761c7a9d977" style="width:px;"><option value="0">...</option><option value="1">Assistant Prof.</option><option value="2">Dr</option><option value="3">Associate Prof.</option><option value="4">Proffesor</option><option value="5">Research Assistant</option><option value="6">Lecturer</option><option value="7">Technical Assistant</option><option value="8">Laboratory Technician</option><option value="9">Principal</option><option value="10">Director</option><option value="11">Scientist</option><option value="12">Researcher</option><option value="13">Other</option></select><input type="hidden" id="custom_list-53761c7a9d977-list-style" value="select"/><input type="hidden" id="custom_list-53761c7a9d977-count" value="13"/></td>
	</tr>
	<tr>
		<td style="width:200px"><label>Latest Qualification Certificate or CV&nbsp;<em>*</em></label></td>
		<td><input type="hidden" name="MAX_FILE_SIZE" value="10240000"/><input name="cv" id="cv" type="file"/></td>
	</tr>
	<tr>
	<td style="width:200px"><label> I agree to Terms of Service and Privacy Policy&nbsp;<em>*</em></label></td>
	<td><input type="checkbox" name="checkbox-53761c7a9e917" id="checkbox-53761c7a9e917" style="float:right;"/></td>
	</tr>
</table>
<div>
<input type="submit" name="submitSignUp" id="submitSignUp" class="submit" value="Submit" />
</div>
</fieldset>
